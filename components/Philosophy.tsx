      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div className="order-1 lg:order-2">
          <span className="inline-flex items-center rounded-full bg-white px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-leaf-700 shadow-soft">
            Play School &amp; Nursery, Sector 137
          </span>
          ...
          <p className="mt-4 text-base text-ink-900/75">
            In the early years, every song, story and game is a lesson in disguise. At SKS World
            School, Noida, our play school and nursery classes build a foundation of curiosity,
            kindness and confidence — so children don&apos;t just learn to read and count, they
          ...
          <ul className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {[
              ...
              "Soft-padded play area for little ones",
            ].map((item) => (
